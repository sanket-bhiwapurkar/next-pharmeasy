...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <Button variant="contained" color="dark">dark</Button>
      ...
      <Button variant="contained" color="warning" fab>warning</Button>
      <Button variant="text" color="warning">warning</Button>
      <Button variant="outlined" color="warning" fab>warning</Button>
